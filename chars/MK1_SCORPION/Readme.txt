;SCORPION from MORTAL KOMBAT by OMEGAPSYCHO
...
Released: 12/08/2013
1st Update:   12/28/2013
2nd Update: 03/08/2015
3rd Update:    06/01/2015
----------------------
HISTORY:
...
*.- Close Strong Punch p2 hurt reaction accurate to Arcade version.
...
*.- Fixed glitch where P1 reached the maximum limit of punches and send everything he touched to the same state after still punching.
...
*.- Fixed glitch where sometimes the enemy was stuck after been thrown.
*.- Height and width of the standardized character (to prevent visual glitches).
...
*.- Fixed speed sweep that ran after stopping abruptly.
*.- Alignment of some sprites.
*.- Alignment of some collision boxes.
*.- Fixed glitch where P2 is untouchable after been hit by HARPOON in mid-air. (Thanks to heil88mugen for the video feedback ;) )
*.- Now P2 can be thrown after being hit by harpoon.
*.- Brand new ".ACT" color set.
...
*.-Have all techniques from "MK1".
*.-Can perform "2 FATALITIES".
*.-Contains two files "Def" : 
	 "MK1_SCORPION.def" = Small & "MK1_SCORPION_Big-Size.def" = BIG (Source game size).
*.-Press Start and you can check the Moves list.
*.-You can choose the SOUND MODE pressing "Start" menu : 
	ARRANGED : some sounds from newest MK games & ORIGINAL : all MK1 sounds.
*.-The fatalities can be performed at any distance.
