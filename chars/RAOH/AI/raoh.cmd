...
triggerall = command = "236_b";"41236_b"
triggerall = statetype != A
triggerall = stateno != 1050
;trigger1 = ctrl = 1
trigger1 = hitdefattr = SC, NA
;trigger1 = animtime = [1,8];
...
trigger3 = stateno=8400 || stateno=8410 || stateno=8420 || stateno=8225 
trigger3 = movecontact && var(59) = 0
trigger4 = stateno = 1001 && stateno = 1003;[1000,1005]
trigger4 = ifelse(stateno=1001,time >= 9, time>= 12); && enemy,movetype != H)
...
trigger3 = stateno=8400 || stateno=8410 || stateno=8411 || stateno=8420 || stateno=8228
trigger3 = movecontact && var(59) = 0
trigger4 = stateno = 1001 && stateno = 1003;[1000,1005]
trigger4 = ifelse(stateno=1001,time >= 9, time>= 12); && enemy,movetype != H)
...
trigger1 = ctrl
trigger2 = movecontact
trigger2 = stateno=8600 || stateno=8610
;trigger2 = var(57) = 1
trigger3 = stateno=8620
trigger3 = time >= 12
...
trigger1 = enemy,hitdefattr = A, NA,SA
...
[State -3]
type = Varset;AIを元に戻したいときはここを「type = null;Varset」と書き換えてください。
triggerall = !var(58)
trigger1 = var(59)
...
[State -3]
type = Varset
trigger1 = var(58) && var(54)
trigger1 = stateno = 1020 || stateno = 2000 || stateno = 2010
var(54) = 2
...
triggerall = !Numhelper(2990) && !Numhelper(2996) && p2stateno != [8715,8716]
...
trigger3 = prevstateno = 8430 || p2bodydist X > 70 && p2stateno = [150,153]
...
trigger1 = Numhelper(2990) || Numhelper(2996) || p2bodydist X < 70
...
trigger1 = stateno = 1000 && animelemtime(6) > 0 || stateno = 1001 && animelemtime(9) > 0
trigger1 = p2statetype = A
...
trigger1 = hitdefattr = SC, NA, SA
trigger1 = movehit
trigger1 = !var(7) && var(27)
trigger1 = stateno = 8410
trigger1 = p2life < 90
trigger1 = random < var(58)*100
...
triggerall = statetype != A
trigger1 = ctrl
trigger1 = var(27) && var(54) && p2stateno = 8716 || target,time > 30 && p2movetype != H
trigger1 = p2statetype = A
trigger1 = p2bodydist X = [-5,50]
...
trigger1 = stateno = 8610 || stateno = 8620 && var(27) || stateno = 8630
trigger1 = random < var(58)*100
...
trigger1 = statetype != A
trigger1 = ctrl
trigger1 = var(27) && var(54) && p2stateno = 8716
trigger1 = (p2bodydist X = [-5,30]) || var(13) && p2bodydist X = [-5,50]
trigger1 = p2bodydist Y = [-60,0]
trigger1 = random < var(58)*100
...
trigger1 = !var(27)
trigger1 = p2statetype != L
trigger1 = p2statetype = A || (p2statetype = C || p2bodydist X > 60) && p2bodydist X > 30
trigger1 = stateno = 8210 || stateno = 8211 || stateno = 8226 || stateno = 8228 || stateno = 8420
trigger1 = random < var(58)*100
...
trigger1 = p2stateno != 100 && p2stateno != [8715,8716]
...
trigger1 = pos Y < -100
trigger2 = p2statetype != L
trigger2 = var(27) && var(7)

;呼法
[State -1]
type = ChangeState
value = 1061
triggerall = var(58) && roundstate = [2,3]
triggerall = statetype != A
trigger1 = hitdefattr = SC, NA
trigger1 = movehit
trigger1 = var(13) < 3
trigger1 = roundstate = 3 || stateno = 8430 && (var(48) < 33 && var(26) < 2 || var(54) = 2)
trigger1 = random < var(58)*100
...
trigger1 = var(54) || p2statetype = L || p2statetype != A && prevstateno = 8430 || random < var(58)*5 || p2stateno = [150,153]
trigger1 = random < var(58)*100
...
trigger1 = var(5) = 0
trigger1 = var(32) = 0
trigger1 = var(27) || p2bodydist X > 50 && vel Y > 0 && p2bodydist Y = [-40,70]
trigger1 = p2movetype != A
trigger1 = random < var(58)*100
...
triggerall = var(58)
triggerall = var(41) = 2
trigger1 = stateno = 8211 && p2bodydist X < 26 || stateno = 8228
trigger1 = movehit
trigger1 = var(7) || !var(27) || var(54)
trigger1 = p2statetype = S
...
triggerall = var(58) && roundstate = 2
triggerall = var(41) = 2
triggerall = !var(7) && !var(27) || Numhelper(2990)
triggerall = random < var(58)*100
trigger1 = hitdefattr = SC, NA
trigger1 = movehit
trigger1 = stateno = 8210 || stateno = 8211 || stateno = 8226 || stateno = 8228 || stateno = 8410 || stateno = 8430
trigger1 = p2bodydist X = [-5,30]
trigger2 = stateno = 8430
trigger2 = p2statetype = A
trigger2 = p2bodydist X = [-5,80]
trigger3 = stateno = 1000 || stateno = 1001 || stateno = 8430
trigger3 = Numhelper(2990)
trigger4 = statetype != A && ctrl
trigger4 = var(27) && (var(7) || var(54))
trigger4 = p2bodydist X = [-5,50]
trigger4 = p2stateno = 8716
...
[State -1, crouch Y];しゃがみ強ぱんち
type = ChangeState
value = 8410
triggerall = var(58) && roundstate = 2
triggerall = var(41) = 2
triggerall = (p2bodydist X = [-5,30]) || (var(48) >= 33 || var(26) >= 2) && p2bodydist X = [-5,40]
...
trigger1 = var(54) = 2
trigger1 = p2statetype = C
trigger2 = stateno = 8211 && var(27) && movehit || stateno=8400 && (moveguarded || p2statetype = C) && var(48) < 33 && var(26) < 2 || stateno = 8420 && moveguarded
trigger2 = movecontact
...
triggerall = random < var(58)*100
trigger1 = movehit
trigger1 = stateno=8210 || stateno = 8211 || stateno=8400 || stateno=8410 || stateno=8420
trigger1 = !var(27)
trigger1 = p2statetype != C
...
triggerall = var(58) && roundstate = 2
triggerall = var(41) = 2
triggerall = p2statetype = A || numhelper(1021)
triggerall = p2bodydist X = [-5,60]
triggerall = p2movetype != H || p2bodydist X < 50
triggerall = p2bodydist Y > -60 || p2movetype = H && p2bodydist Y > -80
triggerall = random < var(58)*100
trigger1 = statetype != A
trigger1 = ctrl
trigger1 = (!var(54) || p2statetype != A) && p2stateno != 8715 && p2stateno != 8716
trigger2 = stateno = 8400
trigger2 = time >= 9
trigger2 = movecontact = 0
trigger3 = movecontact
trigger3 = stateno=8400 && numhelper(1021)
trigger3 = hitpausetime <= 3
trigger3 = p2statetype != A
...
trigger1 = ctrl
trigger1 = p2statetype != L
trigger1 = p2statetype != A || var(54) = 2
trigger1 = p2bodydist X < 70 || var(48) >= 33 || var(26) >= 2
trigger2 = movehit
trigger2 = stateno=8400 || stateno=8420 || stateno=8228
...
trigger1 = random < var(58)*100
trigger2 = movecontact
trigger2 = stateno=8610 || stateno = 8620 && var(57) = 1
trigger2 = p2bodydist Y > -10

[State -1, Air y];空中強パンチ2
type = ChangeState
value = 8610
triggerall = var(58) && roundstate = 2
triggerall = var(41) = 2
...
trigger2 = movecontact
trigger2 = stateno=8610 || stateno=8620 && var(7)
trigger2 = hitpausetime <= 3
...
trigger1 = p2movetype != H || stateno = 234
trigger1 = p2bodydist X = [-5,70]
trigger1 = p2bodydist Y = [-80,70]
trigger1 = random < var(58)*100
trigger2 = movecontact
trigger2 = stateno=8610 || stateno=8600
trigger2 = p2bodydist Y > -10

[State -1, Air y];空中強キック2
type = ChangeState
value = 8630
triggerall = var(58) && roundstate = 2
triggerall = var(41) = 2
triggerall = p2bodydist X < 70
triggerall = p2bodydist Y = [-60,110]
triggerall = random < var(58)*100
trigger1 = statetype = A
trigger1 = ctrl
trigger1 = !var(27)
trigger1 = p2statetype != L
trigger1 = p2statetype = A || vel Y > 0 || p2bodydist X < -20
trigger2 = movecontact
trigger2 = stateno=8600 || stateno=8610 || stateno=8620
trigger2 = p2bodydist Y < -10
...
[State -3,AI用]
type = VarSet
trigger1 = var(58) && stateno = 40
trigger1 = prevstateno = 8410 || prevstateno = 1050
trigger1 = random < var(58)*100
sysvar(1) = 1
...
triggerall = random < var(58)*100
trigger1 = ctrl && p2movetype = H && p2stateno = [8715,8716]
trigger2 = movehit = 1
trigger2 = stateno = 1000 && animelemtime(6) > 0 || stateno = 1001 && animelemtime(9) > 0 || stateno = 8410 && !var(27) && p2bodydist X > 30 || stateno = 8430 && p2bodydist X > 30
...
Trigger1 = 1
Text = "58:%d, Pos X:%f, Pos Y:%f"
Params = var(58),P2BodyDist X, P2BodyDist Y
IgnoreHitPause = 1
SuperMoveTime = 9999
PauseMoveTime = 9999
