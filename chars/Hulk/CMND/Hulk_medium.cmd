...
;======================================================================
; HULK  ::  MEDIUM-tier AI                     [ultimabrawlers / Ikemen GO]
; A clear step below the Hard cmd: NO auto-parry wall (guard never counters),
; basic combo (cLP-cMP xx Gamma Charge, no super), signature command-grab in
; moderation, reacts only to obvious stuff. AILevel-native (0=human).
;======================================================================
...
; -- basic combo: cLP -> cMP xx Gamma Charge (no super extension) --
[State -1, AI Chain cLP->cMP]
type = ChangeState
triggerall = AILevel
trigger1 = stateno = 400 && movecontact
value = 410
[State -1, AI Cancel ->Gamma Charge]
type = ChangeState
triggerall = AILevel
trigger1 = stateno = 410 && movecontact
value = 1002

; -- anti-air Gamma Up (sometimes) --
...
; -- command grab (signature, moderate) --
...
; -- reversal vs obvious attack (Gamma Up only) --
...
; -- approach (Gamma Charge mid-range) + walk-in --
[State -1, AI Gamma Charge approach]
type = ChangeState
triggerall = AILevel >= 3
triggerall = ctrl && statetype != A
triggerall = p2movetype != A
triggerall = p2bodydist X > 90 && p2bodydist X <= 200
