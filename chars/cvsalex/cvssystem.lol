...
triggerall = ifElse(facing=helper(10371),facing, (helper(10371), Var(4)&136) > 0, (helper(10371), Var(4)&68) > 0)
...
type = ChangeAnim
triggerall = NumHelper(10371)
triggerall = ifElse(facing=helper(10371),facing, (helper(10371), Var(4)&68) > 0, (helper(10371), Var(4)&136) > 0)
...
trigger10 = AuthorName = "KoopaKoot" || AuthorName = "Scal" || Authorname = "�g???�fj"
value = 5940
...
type = VarSet
triggerall = NumEnemy
trigger1 = Enemy(0), AuthorName = "Jesuszilla"
...
trigger1 = Enemy(1), AuthorName = "Jesuszilla"
