...
trigger1 = Ctrl = 1
trigger1 = Random >= 880 - AILevel*90
...
;==============================================================================
;|  ULTIMABRAWLERS STRONG-AI v2  -  Kenshiro  (Jotaro/Warusaki3 principles)    |
;|  Combos confirm off the OPPONENT'S hitstun (p2movetype=H), NOT a dice roll  |
;|  -> once a hit lands, the rush/ultimate follows every time. Punishes read   |
;|  opponent recovery (enemy,ctrl=0 / knockdown states). AILevel scales how    |
;|  OFTEN he opens you up & how greedy he punishes - never whether he          |
;|  finishes, so confirms stay reliable at every level. Gated var(59)=1.       |
;|  REVERSIBLE: delete this whole block.                                       |
;==============================================================================

;--- DETERMINISTIC CONFIRM -> Hokuto Ultimate (8800): stars full + my hit landed
[State -1, AI Confirm Hokuto Ultimate]
type = ChangeState
value = 8800
...
;--- DETERMINISTIC CONFIRM -> Hundred Crack Fist (2000): my attack HIT -> always cancel
[State -1, AI Confirm Hundred Crack Fist]
type = ChangeState
value = 2000
triggerall = var(59) = 1 && roundstate = 2
triggerall = power >= 1000
...
triggerall = (p2statetype != A) && (enemy,movetype != A)
trigger1 = random <= 150 + AILevel*65
