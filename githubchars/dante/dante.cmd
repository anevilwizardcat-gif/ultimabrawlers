...
;--------------------------------------------
[Command]
name = "Super Ebony & Ivory Spin EX"
...
;----------------------------------------------
[Command]
name = "Max Super Ebony & Ivory Shot"
...
time = 5
;----------------------------------------------------------------------
[State -1, EX Super Rebilion Slash]
type=ChangeState
value=3767
triggerall=!AILevel && RoundState=2 && StateType != A && var(20) <= 60 && power >= 2000 && command ="EX Super Rebilion Slash"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Super Rebilion Slash]
type=ChangeState
value=3760
triggerall=!AILevel && RoundState=2 && StateType != A && var(20) <= 60 && power >= 1000 && command ="Super Rebilion Slash"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)

;----------------------------------------------------------------------
[State -1, Super Nevan Bats]
type=ChangeState
value=3745
triggerall=!AILevel && RoundState=2 && StateType != A && var(20) <= 60 && power >=2000 && command ="EX Super Nevan Bats"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Super Nevan Bats]
type=ChangeState
value=3740
triggerall=!AILevel && RoundState=2 && StateType != A && var(20) <= 60 && power >=1000 && command ="Super Nevan Bats"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Rage Agni an Rudra LV2]
type=ChangeState
value=3701
triggerall=!AILevel && RoundState=2 && stateno!= 3150 && StateType != A && var(20) <= 60 && power >= 2000 && command ="Rage Agni an Rudra LV2"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;--------------------------------------------------------------------
[State -1, Rage Agni an Rudra LV1]
type=ChangeState
value=3700
triggerall=!AILevel && RoundState=2 && stateno!= 3100 && StateType != A && var(20) <= 60 && power >= 1000 && command ="Rage Agni an Rudra LV1"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Super Ebony & Ivory Spin EX]
type=ChangeState
value=3650
triggerall=!AILevel && RoundState=2 && StateType = A &&var(20)<=0&& power >= 2000&&command ="Super Ebony & Ivory Spin EX"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
trigger3=stateno=1600
trigger4=stateno=1650
;--------------------------------------------------------------------
[State -1, Super Ebony & Ivory Spin]
type=ChangeState
value=3600
triggerall=!AILevel && RoundState=2 && StateType = A &&var(20)<=0&& power >= 1000&&command ="Super Ebony & Ivory Spin"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
trigger3=stateno=1600
trigger4=stateno=1650
;--------------------------------------------------------------------
[State -1, EX Beowulf Down]
type=ChangeState
value=3550
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20)<=0&& power >= 2000&&command ="EX Beowulf Down"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
;--------------------------------------------------------------------
[State -1, Beowulf Down]
type=ChangeState
value=3500
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20)<=0&& power >= 1000&&command ="Beowulf Down"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
;--------------------------------------------------------------------
[State -1, Family Devil My Cry]
type=ChangeState
value=3300
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20)<=0&& power >= 3000&&command ="Family Devil My Cry"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
;--------------------------------------------------------------------
[State -1, Blood Brothers]
type=ChangeState
value=3200
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20)<=0&& power >= 3000&&command ="Blood Brothers"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
;----------------------------------------------------------------------
[State -1,Super Ebony & Ivory Up LV2]
type=ChangeState
value=3450
triggerall=!AILevel && RoundState=2 && (stateno!=[3450,3453]) && StateType != A &&var(20) <= 60 && power >= 2000&&command ="Super Ebony & Ivory Up LV2"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
trigger3=stateno=1100
trigger4=stateno=3400
;----------------------------------------------------------------------
[State -1, Super Ebony & Ivory Up LV1]
type=ChangeState
value=3400
triggerall=!AILevel && RoundState=2 && (stateno!=[3400,3403]) && StateType != A &&var(20) <= 60 && power >= 1000&&command ="Super Ebony & Ivory Up LV1"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo = [110,111])
trigger2=var(6)|| var(7)
trigger3=stateno=1100
;----------------------------------------------------------------------
[State -1, Max Ice Cerberus]
type=ChangeState
value=3150
triggerall=!AILevel && RoundState=2 && (stateno!=[3050,3051]) && StateType != A &&var(20) <= 60 && power >= 2000&&command ="Max Ice Cerberus"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Ice Cerberus]
type=ChangeState
value=3100
triggerall=!AILevel && RoundState=2 && (stateno!=[3100,3101]) && StateType != A &&var(20) <= 60 && power >= 1000&&command ="Ice Cerberus"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo = [110,111])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Max Super Ebony & Ivory Shot]
type=ChangeState
value=3050
triggerall=!AILevel && RoundState=2 && (stateno!=[3050,3051]) && StateType != A &&var(20) <= 60 && power >= 2000&&command ="Max Super Ebony & Ivory Shot"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
trigger3=stateno=3000
;----------------------------------------------------------------------
[State -1, Super Ebony & Ivory Shot]
type=ChangeState
value=3000
triggerall=!AILevel && RoundState=2 && (stateno!=[3000,3001]) && StateType != A &&var(20) <= 60 && power >= 1000&&command ="Super Ebony & Ivory Shot"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
trigger3 = stateno = 1852
;------------------------------------------------------------------------
[State -1, Eletric bat's Nevan]
type=ChangeState
value=Ifelse(command="EX Eletric bat's Nevan"&&var(20) <= 60&&power>=500,2050,2000)
triggerall=!AILevel && RoundState=2 && StateType != A && Ifelse(!var(20),!Numhelper(2005),Numhelper(2005)<5)
triggerall=(command="Eletric bat's Nevan")||(command="EX Eletric bat's Nevan"&&power>=500&&var(20) <= 60)
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo = [110,111])
trigger2=var(5)
trigger3=(stateno = 455) && movecontact && (command="EX Eletric bat's Nevan"&&power>=500&&var(20) <= 60)
trigger4 = (stateno = [200,450])&&stateno!=420&&movecontact
;---------------------------------------------------------------------------------------------
[State -1, EX Ebony & Ivory Shot Up]
type = ChangeState
value = 1150
triggerall =  !AILevel && roundstate=2 && statetype!=A&&var(20) <= 60&&power>=500
triggerall = command = "EX Ebony & Ivory Shot Up" 
trigger1 = ctrl
trigger2 = (stateno = [200,450])&&stateno!=420&&movecontact
trigger3= var(5)
trigger4 = stateno = 1100
;-------------------------------------------------------------------------
[State -1, Ebony & Ivory Shot Up]
type = ChangeState
value = 1100
triggerall =  !AILevel && roundstate=2 && statetype!=A
triggerall = command = "Ebony & Ivory Shot Up" 
trigger1 = ctrl
trigger2 = (stateno = [200,450])&&stateno!=420&&movecontact
trigger3= var(5)
trigger4 = stateno = 420&&movecontact
;-------------------------------------------------------------------------
[State -1, EX Rebilion Drill]
type=changestate
value=1950
triggerall=!AILevel && RoundState=2&& statetype!=A
triggerall = command = "EX Rebilion Drill"
trigger1= ctrl 
trigger2 = (stateno = [200,450])&&stateno!=420&&movecontact
trigger3= var(5)
trigger4=(stateno = [1200,1202])
trigger5 = (stateno = [200,450])&&movecontact
trigger6=stateno=1701
trigger7=(stateno = [1300,1302])
;-------------------------------------------------------------------------
[State -1, Rebilion Drill]
type=changestate
value=1900
triggerall=!AILevel && RoundState=2&& statetype!=A
triggerall = command = "Rebilion Drill"
trigger1= ctrl 
trigger2 = (stateno = [200,450])&&stateno!=420&&movecontact
trigger3= var(5)
trigger4=(stateno = [1200,1202])
trigger5 = (stateno = [200,450])&&movecontact
trigger6=(stateno = [1300,1302])
;-------------------------------------------------------------------------
[State -1, EX Flash Kick]
type = ChangeState
value = 1750
triggerall =  !AILevel && roundstate=2 && statetype!=A&&var(20) <= 60&&power>=500
triggerall = command = "kk" && var(56) >= 5
trigger1= ctrl || stateno=40 || stateno=52 || (stateno=[100,101])
trigger2 = (stateno = [200,455])&&stateno!=420&&movecontact
trigger3= var(5)
trigger4=(stateno = [1700,1702])
;-------------------------------------------------------------------------
[State -1, Flash Kick]
type = ChangeState
value = 1700
triggerall=!AILevel && RoundState=2
triggerall = (command = "a" || command = "b" || command = "c") && var(56) >= 5
...
;--------------------------------------------------------
[State -1, Ebony & Ivory Shot EX]
type = ChangeState
value = 1503
triggerall = command = "Ebony & Ivory Shot EX"
triggerall = RoundState = 2 && StateType != A &&var(20) <= 60&&power>=500
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,450])
trigger2 = var(5)
trigger3=stateno=1500
trigger4=stateno=1501
trigger5=stateno=1502
;--------------------------------------------------------
[State -1, Ebony & Ivory Shot 1]
type = ChangeState
value = 1500
triggerall = command = "Ebony & Ivory Shot"
triggerall = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,450])
trigger2 = var(5)
;--------------------------------------------------------
[State -1, Ebony & Ivory Shot 2]
type = ChangeState
value = 1501
triggerall = command = "Ebony & Ivory Shot 2"
triggerall = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,450])
trigger2 = var(5)
;--------------------------------------------------------
[State -1, Ebony & Ivory Shot 3]
type = ChangeState
value = 1502
triggerall = command = "Ebony & Ivory Shot 3"
triggerall = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,450])
trigger2 = var(5)
;------------------------------------------------------------------------
...
value = 1350
triggerall =  !AILevel && roundstate=2 && statetype!=A&&var(20) <= 60&&power>=500
triggerall = command = "EX Cerberus" 
trigger1 = ctrl
trigger2 = (stateno = [200,450])&&stateno!=420&&movecontact
trigger3= var(5)
...
value=1300
triggerall=!AILevel && RoundState=2&& statetype!=A
triggerall = command = "Cerberus"
trigger1= ctrl 
trigger2 = (stateno = [200,450])&&stateno!=420&&movecontact
trigger3= var(5)
trigger4=(stateno = [1700,1702])
trigger5=(stateno = [1200,1202])
;-------------------------------------------------------------------------
[State -1, Cerberus 2]
type=changestate
value=1301
triggerall=!AILevel && RoundState=2&& statetype!=A
triggerall = command = "Cerberus 2"
trigger1= ctrl 
trigger2 = (stateno = [200,450])&&stateno!=420&&movecontact
trigger3=stateno=1300
trigger4= var(5)
trigger5=(stateno = [1700,1702])
trigger6=(stateno = [1200,1202])
;-------------------------------------------------------------------------
[State -1, Cerberus 3]
type=changestate
value=1302
triggerall=!AILevel && RoundState=2&& statetype!=A
triggerall = command = "Cerberus 3"
trigger1= ctrl 
trigger2 = (stateno = [200,450])&&stateno!=420&&movecontact
...
trigger6=(stateno = [1200,1202])
;-------------------------------------------------------------------------
[State -1, Piercing Reblilion]
type = ChangeState
value = 1250
triggerall =  !AILevel && roundstate=2 && statetype!=A&&var(20) <= 60&&power>=500
triggerall = command = "pp" && var(46) >= 3
trigger1= ctrl || stateno=40 || stateno=52 || (stateno=[100,101])
trigger2 = (stateno = [200,455])&&stateno!=420&&movecontact
trigger3= var(5)
trigger4=stateno=1201&&movecontact
trigger5=(stateno = [1700,1750])
;-------------------------------------------------------------------------
[State -1, Piercing Reblilion]
type = ChangeState
value = 1200
triggerall=!AILevel && RoundState=2
triggerall = (command = "x" || command = "y" || command = "z") && var(46) >= 3.5
triggerall = !statetype = A
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo = [110,111])
trigger2 = (stateno = [200,455])&&stateno!=420&&movecontact
trigger3= var(5)
trigger4=(stateno = [1700,1750])
;-------------------------------------------------------------------------
[State -1, EX Spin Ebony & Ivory Shot]
type = ChangeState
value = 1650
triggerall =  !AILevel && roundstate=2 && statetype=A&&var(20) <= 60&&power>=500&& !numhelper(1055)
triggerall = command = "EX Spin Ebony & Ivory Shot" 
trigger1 = ctrl
trigger2 = (stateno = [200,650])&&stateno=420&&movecontact
trigger3=var(5)|| var(2)
trigger4=(stateno = [600,650])&&movecontact
trigger5=stateno =1600 
;------------------------------------------------------------------------
[State -1, Spin Ebony & Ivory Shot]
type = ChangeState
value = 1600
triggerall =  !AILevel && roundstate=2 && statetype=A
triggerall = command = "Spin Ebony & Ivory Shot" 
trigger1 = ctrl
trigger2 = (stateno = [200,450])&&stateno!=420&&movecontact
trigger3=var(5)|| var(2)
trigger4=(stateno = [600,650])&&movecontact
...
;---------------------------------------------------------------------------
[State -1, Family Devil My Cry AI]
type=changestate
value=3300
...
;---------------------------------------------------------------------------
[State -1, Beowulf Down LV1 AI]
type=ChangeState
value=3500
triggerall=AILevel && numenemy && RoundState=2 && (stateno!=[3000,3001]) && StateType != A &&var(20) <= 60 && power >= 1000 && random < (150 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype != L) &&(enemynear,stateno!=[5100,5220]) &&(p2bodydist x >=10) && (p2bodydist y =[-40,5])
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo=[110,111])
trigger2=var(6)|| var(7)

;--------------------------------------------------------------------------
[State -1, Beowulf Down LV2 AI]
type=ChangeState
value=3550
triggerall=AILevel && numenemy && RoundState=2 && (stateno!=[3000,3001]) && StateType != A &&var(20) <= 60 && power >= 2000 && random < (150 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype != L) &&(enemynear,stateno!=[5100,5220]) &&(p2bodydist x >=10) && (p2bodydist y =[-40,5])
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo=[110,111])
trigger2=var(6)|| var(7)

;---------------------------------------------------------------------------
[State -1, Super Nevan Bats LV1 AI]
type=ChangeState
value=3740
triggerall=AILevel && numenemy && RoundState=2 && (stateno!=[3000,3001]) && StateType != A &&var(20) <= 60 && power >= 1000 && random < (150 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype != L) &&(enemynear,stateno!=[5100,5220]) &&(p2bodydist x >=10) && (p2bodydist y =[-40,5])
...
;---------------------------------------------------------------------------
[State -1, Super Nevan Bats LV2 AI]
type=ChangeState
value=3745
triggerall=AILevel && numenemy && RoundState=2 && (stateno!=[3000,3001]) && StateType != A &&var(20) <= 60 && power >= 2000 && random < (150 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype != L) &&(enemynear,stateno!=[5100,5220]) &&(p2bodydist x >=10) && (p2bodydist y =[-40,5])
...
trigger2=var(6)|| var(7)
;---------------------------------------------------------------------------
[State -1, Max Super Ebony & Ivory Spin AI]
type=ChangeState
value=3650
triggerall=AILevel && numenemy && RoundState=2 && (stateno!=[3550,3553]) && StateType != A &&var(20)<=60&& power >= 2000 && random < (150 * (AIlevel ** 2 / 64.0))
...
trigger3=(var(7)) && movehit && random<50
;---------------------------------------------------------------------------
[State -1, Super Ebony & Ivory Spin AI]
type=ChangeState
value=3600
triggerall=AILevel && numenemy && RoundState=2 && (stateno!=[3500,3503]) && StateType != A &&var(20)<=60&& power >= 1000 && random < (250 * (AIlevel ** 2 / 64.0))
triggerall=(p2stateno != [120, 155]) && (enemynear,statetype != L) &&(enemynear,stateno!=[5100,5220]) &&(p2bodydist x =[20,80]) && (p2bodydist y =[-80,5]) &&(enemynear, statetype =S)
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo=[110,111])
trigger2=(var(6)) && movehit && random<200
trigger3=(var(7)) && movehit && random<50
;---------------------------------------------------------------------------
[State -1,  Super Rebilion Slash AI]
type=ChangeState
value=3760
triggerall=AILevel && numenemy && RoundState=2 && (stateno!=[3500,3503]) && StateType != A &&var(20)<=60&& power >= 1000 && random < (250 * (AIlevel ** 2 / 64.0))
triggerall=(p2stateno != [120, 155]) && (enemynear,statetype != L) &&(enemynear,stateno!=[5100,5220]) &&(p2bodydist x =[20,80]) && (p2bodydist y =[-80,5]) &&(enemynear, statetype =S)
...
trigger3=(var(7)) && movehit && random<50
;---------------------------------------------------------------------------
[State -1, EX Super Rebilion Slash AI]
type=ChangeState
value=3767
triggerall=AILevel && numenemy && RoundState=2 && (stateno!=[3500,3503]) && StateType != A &&var(20)<=60&& power >= 2000 && random < (250 * (AIlevel ** 2 / 64.0))
triggerall=(p2stateno != [120, 155]) && (enemynear,statetype != L) &&(enemynear,stateno!=[5100,5220]) &&(p2bodydist x =[20,80]) && (p2bodydist y =[-80,5]) &&(enemynear, statetype =S)
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo=[110,111])
trigger2=(var(6)) && movehit && random<200
trigger3=(var(7)) && movehit && random<50
;----------------------------------------------------------------------
[State -1, Rage Agnis E Rudra Skills]
type=ChangeState
value=Ifelse(power>=2000 && random<=500,3701,3700)
triggerall=AILevel && numenemy && RoundState=2 && (stateno!=3100) && StateType != A && var(20)<=60 && power >= 1000 && random < (250 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype != L) && (enemynear,Statetype!=C) &&(enemynear,stateno!=[5100,5220])&&(enemynear,stateno!=[120,155])&&(p2bodydist x =[20,80])&&(p2bodydist y=[-80,5])
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;---------------------------------------------------------------------------
[State -1,Super Ebony & Ivory Up LV2 AI]
type=ChangeState
value=3450
...
trigger3=(var(7)) && movehit && random<50
;-------------------------------------------------------------------------
[State -1, Super Ebony & Ivory Up LV1 AI]
type=ChangeState
value=3400
...
trigger3=(stateno=[200,450]) && movehit && random < (100 * (AIlevel ** 2 / 64.0))
;---------------------------------------------------------------------------
[State -1, Super Ebony & Ivory Shot LV1 AI]
type=ChangeState
value=3000
triggerall=AILevel && numenemy && RoundState=2 && (stateno!=[3000,3001]) && StateType != A &&var(20) <= 60 && power >= 1000 && random < (150 * (AIlevel ** 2 / 64.0))
...
trigger3=(stateno=[200,450]) && movehit && random < (100 * (AIlevel ** 2 / 64.0))
;------------------------------------------------------------------------
[State -1, Super Ebony & Ivory Shot LV2 AI]
type=ChangeState
value=3050
triggerall=AILevel && numenemy && RoundState=2 && (stateno!=[3050,3051]) && StateType != A &&var(20) <= 60 && power >= 2000 && random < (120 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype != L) &&(enemynear,stateno!=[5100,5220]) &&(p2bodydist x >=10) && (p2bodydist y =[-90,5])
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo=[110,111])
trigger2=var(6)|| var(7)
trigger3=(stateno=[200,450]) && movehit && random < (100 * (AIlevel ** 2 / 64.0))
;---------------------------------------------------------------------------
[State -1, Flash Kick AI]
type = changestate
value=Ifelse((power >= 500 && random < 100), 1750, 1700)
...
trigger4= EnemyNear, GetHitVar(HitTime) >= 4 && Random < (100 * (AILevel ** 2 / 64.0))
trigger5 = var(6) && MoveHit && Random < (100 * (AILevel ** 2 / 64.0))
trigger5 = EnemyNear, GetHitVar(HitTime) >= 8
trigger6=var(5)
;---------------------------------------------------------------------------
[State -1, Ebony & Ivory Shot AI]
type=ChangeState
...
;---------------------------------------------------------------------------
[State -1, Rebilion Drill AI]
type = ChangeState
value = ifElse(Power >= 500 && Random < 100 && (P2BodyDist x = [0,145]), 1950, 1900)
triggerall=AILevel && RoundState=2 && numenemy && StateType != A && var(20)<=60 
triggerAll = (P2BodyDist x = [0,185]) && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100,101])) && Random < (50 * (AILevel ** 2 / 64.0))
...
trigger6=var(5)
;---------------------------------------------------------------------------
[State -1, Ebony & Ivory Shot Up AI]
type=ChangeState
...
trigger7 = stateno = 1450 && (p2bodydist x = [ -40, 40])
;---------------------------------------------------------------------------
[State -1, Spin Ebony & Ivory Shot AI]
type = changestate
...
[State -1, Eletric bat's Nevan]
type=ChangeState
value=Ifelse((power >= 500 && random < 100), 2050, 2000)
triggerall=AILevel && RoundState=2 && numenemy && StateType != A && !numhelper(3005) && !Numhelper(3055) && !Numhelper(1805) && Ifelse(!var(20), !numhelper(2005), numhelper(2005)<=1)
triggerall=(p2bodydist x=[30,200]) && (p2bodydist y = [ -80, 5])&& enemynear,statetype!=L && random < (150 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,stateno!=[5100,5220]) && !Numtarget(1350) && (!var(16) && var(15)<1||var(20))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
