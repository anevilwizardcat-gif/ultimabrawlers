...
[Command]
name = "Fatality2SCORPION"
command = ~D,D,B,F,F,B
time = 66

[Command]
name = "Fatality1SCORPION"
command = ~U,U
time = 30
...
trigger2 = stateno = 251 && statetype = A && pos y >-35
trigger3 = stateno = 52 && statetype = A && pos y >-35
ignorehitpause = 1
value = 381
...
;FATALITY # 1 SCORPION
[State -1, FATALITY # 1 SCORPION]
type = ChangeState
triggerall = P2Dist X < 260
triggerall = RoundState = 2
triggerall = p2stateno = 49999
triggerall = var(55) = 1
triggerall = command = "Fatality1SCORPION"
triggerall = statetype != A
trigger1 = Ctrl 
...
;FATALITY # 2 SCORPION
[State -1, FATALITY # 2 SCORPION]
type = ChangeState
triggerall = P2Dist X < 260
triggerall = RoundState = 2
triggerall = p2stateno = 49999
triggerall = var(55) = 1
triggerall = command = "Fatality2SCORPION"
triggerall = statetype != A
trigger1 = Ctrl 
trigger2 = stateno = 130
trigger3 = stateno = 131
