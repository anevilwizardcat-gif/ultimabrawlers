...
[Command]
name = "Fatality2SUBZERO"
command = ~B,B,D,F,B
time = 50

[Command]
name = "Fatality1SUBZERO"
command = ~F,D,F,y
time = 40
...
triggerall = command != "Fatality1SUBZERO"
triggerall = command != "holddown"
triggerall = statetype = S
triggerall = p2bodydist x >=10
trigger1 = Ctrl 
...
type = ChangeState
triggerall = var(50) = 0
triggerall = NumHelper(357)= 0
triggerall = NumProjID(358) = 0
triggerall = RoundState = 2
triggerall = command = "Ice"
triggerall = statetype != A
trigger1 = ctrl
...
;FATALITY # 1 SUB-ZERO
[State -1, FATALITY # 1 SUB-ZERO]
type = ChangeState
triggerall = P2Dist X < 270
triggerall = RoundState = 2
triggerall = p2stateno = 49999
triggerall = var(55) = 1
triggerall = command = "Fatality1SUBZERO"
...
;FATALITY # 2 SUB-ZERO
[State -1, FATALITY # 2 SUB-ZERO]
type = ChangeState
triggerall = P2Dist X < 270
triggerall = RoundState = 2
triggerall = p2stateno = 49999
triggerall = var(55) = 1
triggerall = command = "Fatality2SUBZERO"
triggerall = statetype != A
trigger1 = stateno = [120,141]
ignorehitpause = 1
value = 600
